$(document).ready(function () {
    Snippet.utils.registerBackToTop();
    Snippet.utils.wrapImageWithFancyBox();

    if(!CONFIG.isIndex){
        initScrollSpy();
        Snippet.utils.needAffix() && initAffix();
    }
...
$(document).ready(function () {
    ...
    $('.post-toc a').on('click', function (e) {
        e.preventDefault();
        var targetSelector = Snippet.utils.escapeSelector(this.getAttribute('href'));
...
function initAffix () {
    ...
    var footerOffset = parseInt($('.main-content').css('padding-bottom'), 10);
...
function initTOCDimension () {
    ...
    var scrollbarWidth = Snippet.utils.getScrollbarWidth();
